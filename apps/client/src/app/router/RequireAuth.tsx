...
export function RequireAuth() {
  ...
  if (status === 'loading') {
    /*
     * Empty for the first 400ms, which is what this was before and what the reasoning it
     * carried actually justified: the session check is a same-origin request that lands in a
     * frame or two, and a spinner that appears for 40ms is more distracting than nothing.
     *
     * Past that it is not a frame or two, and "nothing" was the whole page. `RouteFallback`
     * draws the same distinction `SiteLayout`'s does — see the note there.
     */

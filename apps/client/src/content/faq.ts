...
export const faqItems: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Then a rebuild is probably the wrong purchase, and the honest first step is the free website assessment — the real site, looked at against the same twenty checks the website score uses, with the specific things costing you enquiries named. What usually comes out of that is a smaller piece of corrective work: the contact paths, the clarity, the trust gaps, the speed and mobile problems inside your existing design, with the conversion tracking set up and verified and a baseline recorded so you can see what changed. It is quoted in writing before anything starts, and it is quoted from the real site rather than from a form, because pricing repairs you have not seen is a guess. What it is not is a redesign, new pages, or a platform move — and if the honest answer is that you need one of those, we will say so rather than sell you the smaller thing twice.',
  },
  {
    id: 'contract',

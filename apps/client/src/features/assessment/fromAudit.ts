...
import type { AssessmentAnswer, AssessmentCategory, AssessmentRequest } from '@jobforge/shared';
import { ASSESSMENT_CATEGORIES } from '@jobforge/shared';
import type { CategoryScore, ScoreMap } from '../public/playbook';

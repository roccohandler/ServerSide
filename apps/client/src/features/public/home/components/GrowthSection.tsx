    ...
    <Section labelledBy={HEADING_ID}>
      <Container>
        ...
        <div className={styles['match']}>
          ...
          <div className={offer['matchPanels']}>
            ...
            <Reveal className={valueStyles['panel']}>
              <p className={cx(valueStyles['panelLabel'], valueStyles['panelLabelAfter'])}>
                <span className={valueStyles['panelSide']}>
        ...
        {seasonal.enabled ? (
          <div className={offer['block']}>
            <h3 id={SEASONAL_HEADING_ID} className={offer['blockHeading']}>
              {seasonal.heading}
            </h3>
            <p className={offer['blockLede']}>{seasonal.lede}</p>
            ...
            <p className={offer['careNote']}>{seasonal.note}</p>
          </div>
        ) : null}
        ...
        {abTesting.enabled ? (
          <div className={offer['block']}>
            <h3 id={TESTING_HEADING_ID} className={offer['blockHeading']}>
              {abTesting.heading}
            </h3>
            <p className={offer['blockLede']}>{abTesting.lede}</p>
            ...
            <div className={styles['variants']}>
              ...
              <div className={offer['variantGrid']}>

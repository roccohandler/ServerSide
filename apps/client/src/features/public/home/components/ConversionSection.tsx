  ...
  return (
    <Section tone="muted" labelledBy={HEADING_ID}>
      <Container>
        ...
        {/*
         * The chain, and the sentence that explains it, side by side.
         *
         * The explanation used to sit underneath — which meant a reader met ten steps
         * across 1,300px and only then found out where the boundary they had just
         * scrolled past was drawn. It belongs level with the diagram it describes, and
         * the column it takes was empty space.
         */}
        ...
        <Grid as="ul" columns={3}>
          {outcomes.map((outcome) => (
            <Reveal as="li" key={outcome.id} className={offer['careItem']}>
              <Card className={offer['careCard']} interactive>

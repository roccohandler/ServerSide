...
const WHAT_HAPPENS_NEXT = [
  'Your message goes straight to the person who does the work — no queue, no call centre.',
  'We reply from the email address you give here.',
  'If a website is not what you need, we will say so instead of quoting.',
] as const;
    ...
    <aside className={styles['details']} aria-labelledby="contact-details-heading">
      <div>
        ...
        <p className={styles['detailsBody']}>
          Both go straight to the person who does the work. Calling is the fastest way to get an
          answer.
        </p>
      ...
      <div>
        <h2 className={styles['detailsHeading']}>Where we work</h2>
        <p className={styles['detailsBody']}>

 ...
 *
 * The unread count is a third caller and needs no third index — it is the first compound
 * key with a range on `createdAt` instead of a sort, which the same key serves.
 */

...
const userSchema = new Schema<UserDocument>(
  {
    ...
    /*
     * No default. Absent means "has never caught up", which the unread count reads as
     * "since the account was created" — a `default: Date.now` here would instead silently

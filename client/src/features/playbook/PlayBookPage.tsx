 ...
 * address — a reader who never gives me theirs should still leave able to find real
  ...
  return (
    <>
      ...
      <CtaBanner
        ...
        body="Send it over and I will go through it the way a customer would, then write back with what I would change first. Free, and useful whether or not you ever hire anybody."
      />
    </>
  );
}

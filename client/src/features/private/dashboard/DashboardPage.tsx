...
import { fetchDashboard } from '../api/appApi';
 ...
 *      `server/src/features/dashboard/currentAction.ts`. One thing, never three competing
...
export function DashboardPage() {
  ...
  useEffect(() => {
    ...
    void fetchDashboard(controller.signal).then((result) => {
  ...
  if (!data) return <AppLoading label="Loading your dashboard" />;

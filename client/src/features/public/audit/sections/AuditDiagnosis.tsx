...
import { conversionFix, flagship, recommendedAction } from '../../../../config/pricing';
          ...
          <>
            ...
            <div className={styles['recommendation']}>
              {action === 'rebuild' ? (
                 ...
                 *
                 * It now names the product, states its boundary, and gives them the same
                 * kind of action the rebuild branch has always had. The event is the
                 * existing `pricing_tier_selected` with a different `tier`, because "which
                 * product did they reach for" is the question it already answers.
                 * ==================================================================
                 */
                <>
                  <h3 className={styles['recommendationHeading']}>
                  ...
                  <p className={styles['recommendationLead']}>
                    {diagnosis.recommendation.fix.lead}{' '}
                    <strong className={styles['recommendationTier']}>{conversionFix.name}</strong>.
                  </p>

      ...
      <Container>
              ...
              <div className={styles['responseColumn']}>
                ...
                <ul className={styles['responseList']}>
                  {responseGuarantee.channels.map((channel) => (
                    <li key={channel} className={styles['careListItem']}>
                      <Icon name="mail" size={16} className={styles['careMarker']} />
                      <span>{channel}</span>
                    </li>
                  ))}
        ...
        <div className={valueStyles['objection']}>
          ...
          <div className={valueStyles['controlGrid']}>
            ...
            <div className={`${valueStyles['controlColumn']} ${valueStyles['controlColumnMuted']}`}>
              <h4 className={valueStyles['controlHeading']}>
